    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?= media()?>/images/icon_usu.png" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">Daniel Peris</p>
      ...
      <ul class="app-menu">
        ...
        <li><a class="treeview-item" href="<?= base_url()?>Usuarios"><i class="icon bi bi-circle-fill"></i>Usuarios</i></a></li>
        ...
        <li>
            <a class="app-menu__item" href="<?= base_url()?>productos">
                <i class="app-menu__icon bi bi-archive"></i>
